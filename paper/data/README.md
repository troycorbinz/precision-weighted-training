...
- `inter_annotator_agreement` — Human-aggregate vs FM-aggregate per-question agreement metrics: same-majority count (out of 32), Pearson correlation of per-question B%-decisive between the two judge types, and per-question detail.
